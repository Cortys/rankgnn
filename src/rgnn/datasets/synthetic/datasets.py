...
from rgnn.utils import cart, local_seed, unzip
import rgnn.preprocessing.utils as preproc
from rgnn.datasets.synthetic.provider import \
...
@synthetic_graph_embed_dataset(type="integer", min=0, max=9)
